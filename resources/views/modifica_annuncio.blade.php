            ...
            <div class="form-row">
                ...
                <div class="input-box_scelta">
                    ...
                    <div class="tipologia_inserimento_annuncio">
                        ...
                        {{ Form::radio('tipologia', '0',!$annuncio->tipologia, ['class' => 'input','id' => 'tipologia']) }}
                        {{ Form::label('tipo_annuncio', 'PostoLetto', ['class' => 'label-input']) }}
                        {{ Form::radio('tipologia', '1',$annuncio->tipologia, ['class' => 'input','id' => 'tipologia']) }}
                    </div>
                </div>
...
<script src="{{ asset('js/inserisci_annuncio.js') }}"></script>
@endisset()
@endsection