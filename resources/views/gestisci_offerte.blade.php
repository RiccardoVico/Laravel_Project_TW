...
<div class="page-section" style="background-color:#E6E6FA">
    <div class="container">
        <div class="col text-center pb-3">
            ...
            <a href = "{{ route('annunciopzionati', [Auth::user()->id]) }}" class="btn btn-outline-light"> Annunci opzionati</a>
            <a href = "{{ route('ins2') }}" class="btn btn-outline-light">Inserisci nuovo</a>
        </div>
